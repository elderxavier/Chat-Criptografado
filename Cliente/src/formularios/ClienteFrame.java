...
import logica.ChatMessage;
import logica.ChatMessage.Action;
...
public class ClienteFrame extends javax.swing.JFrame {
    ...
    private void receive(ChatMessage message) {
        Descriptografa descriptografa = new Descriptografa(message.getText());
        //this.txtAreaReceive.append(message.getName() + " diz: " + message.getText() + "\n");
        this.txtAreaReceive.append(message.getName() + " diz: " + descriptografa.getSenhaDescr() + "\n");
    }
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        ...
        Criptografa criptrografa = new Criptografa(text);
        text = criptrografa.GetSenhaCript();
        Descriptografa descriptografa = new Descriptografa(text);
        ...
        if (!text.isEmpty()) {
            ...
            //this.message.setText(descriptografa.getSenhaDescr());

            //this.txtAreaReceive.append("Você disse: " + text + "\n");
            this.txtAreaReceive.append("Você disse: " + descriptografa.getSenhaDescr() + "\n");
